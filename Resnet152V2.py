...
# model
base_model = Resnet152V2(weights=None, include_top=False, input_shape=(229, 229, 3))
...
checkpoint = ModelCheckpoint("Resnet152V2.h5", monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='min', period=1)
early = EarlyStopping(monitor='val_loss', min_delta=0, patience=30, verbose=1, mode='min')

#compile model
EPOCHS = 400
BS = 32
opt = SGD(learning_rate=1e-6, momentum=0.9, nesterov=True, decay=1e-10)
...
model.save('model/Resnet152V2-final.h5')
