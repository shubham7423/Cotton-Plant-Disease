...
checkpoint = ModelCheckpoint("InceptionResnetV2.h5", monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='min', period=1)
...
model.save('model/InceptionResnetV2-final.h5')
