...
# model
base_model = Xception(weights=None, include_top=False, input_shape=(229, 229, 3))
...
checkpoint = ModelCheckpoint("Xception.h5", monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='min', period=1)
...
model.save('model/Xception-final.h5')
